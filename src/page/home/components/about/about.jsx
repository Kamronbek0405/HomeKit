    ...
    return (
        <div className="w-[100%] h-auto bg-gradient-to-t from-black via-red-950 to-black mt-10 flex items-center flex-col">
            ...
            >
                ...
                <div className="  md:ml-5   lg:w-[450px]">
                    <h1 className=" text-xl  font-medium lg:leading-tight  tracking-wide md:text-3xl md:mb-8   lg:text-4xl lg:mb-10">{t("HOMEKIT AQLLI PARDALARI")}</h1>
                    <p className=" tracking-normal mt-2 text-xs    font-light md:text-sm lg:w-[400px] lg:text-lg">{t("HomeKit aqlli pardalari bilan hayot yanada zavqli ko'rinishga kiradi. Birgina qo'lingizdagi telefon orqali istalgan paytda pardalarni boshqaring.")}</p>
                </div>
            </div>
            ...
            <div className='flex mt-20 px-2 gap-3 ml-2 md:gap-16  lg:gap-10 lg:flex lg:items-center '>
                <div className='text-white  w-[200px] flex items-center flex-col  h-[320px] rounded-lg bg-gradient-to-b from-gray-700 to-rose-900 lg:bg-gradient-to-b lg:from-gray-700 lg:to-rose-900  lg:rounded-2xl md:w-[300px] md:h-[400px]   lg:w-[500px] lg:h-[620px] lg:bg-gray-300 lg:flex lg:flex-col lg:items-center ' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    ...
                    <div className='  md:mt-5 md:ml-5 lg:px-10'>
                        <h1 className='  font-medium tracking-widest  ml-2 text-sm  mt-2  leading-tight w-[150px] md:text-xl md:w-[200px] lg:text-4xl lg:w-[400px] lg:ml-10 lg:py-2 lg:tracking-widest'>{t("HOMEKIT AQLLI QULFLARI")}</h1>
                ...
                <div
                    className='text-white  w-[200px] flex items-center flex-col  h-[320px] rounded-lg bg-gradient-to-b from-gray-700 to-rose-900   md:w-[300px] md:h-[400px]  lg:w-[500px] lg:h-[620px] lg:rounded-2xl lg:bg-gray-300 lg:flex lg:flex-col lg:items-center   '
                    data-aos="fade-left"
                    data-aos-offset="300"
                ...
                >
                    <img
                        className='w-[180px]  mt-5  h-[120px] rounded-lg md:w-[250px] md:h-[150px] lg:w-[350px] lg:mt-14 lg:h-[250px]'
                        src="https://www.homekit.uz/static/media/newr.a27de1cd6fa5b7be2207.jpg"
                        alt=""
                    />
                    <div className='  md:mt-5 md:ml-5 lg:px-10'>
                        <h1 className='font-medium  tracking-widest  ml-3 text-sm  mt-2  lg:py-2 leading-tight w-[150px] md:text-xl md:w-[200px] lg:ml-10 lg:text-4xl'>{t("SMART ROZETKALAR")}</h1>
            ...
            >
                ...
                <div className="  md:ml-5   lg:w-[450px]">
                    <h1 className="text-xl  font-medium lg:leading-tight  tracking-wide md:text-2xl md:mb-4  lg:text-4xl lg:mb-10">{t("HOMEKIT BILAN UYNI AQLLI BOSHQARISH")}</h1>
                    <p className=" tracking-normal mt-2 text-xs    font-light md:text-sm lg:w-[400px] lg:text-lg">{t("Hisoblagichlar, rozetkalar kabi aqlli qurilmalar orqali kvartirani energiyani tejashni boshqaring va elektr energiyasini isrof qilishning oldini olish uchun bizning masofaviy va muntazam elektr jihozlarimizdan foydalaning.")}</p>
                </div>
            </div>
            ...
            >
                ...
                <div className="  md:ml-5  lg:w-[450px]">
                    <h1 className="text-xl font-medium lg:leading-tight tracking-wide  md:text-2xl md:mb-4 lg:text-4xl lg:mb-10">{t("HOMEKIT AQLLI KAMERALARI")}</h1>
                    <p className="tracking-normal mt-2 text-xs font-light  md:text-sm lg:w-[400px] lg:text-lg">
            ...
            <div id='about' className=' w-[100%]  h-[130vh] flex    items-center justify-center  relative mt-20 md:h-[65vh] md:flex      lg:w-[100%]  lg:h-[700px] lg:flex lg:items-center lg:justify-center lg:relative lg:mt-20'>
                <div className=" absolute bg-bgroundColorCream flex flex-col justify-center w-[390px] h-[400px] px-8 gap-5 top-3 rounded-2xl md:left-16  md:w-[700px]  md:top-52 lg:mt-20 lg:bg-bgroundColorCream lg:w-[900px] lg:h-[488px] lg:relative lg:py-[40px] lg:px-20 lg:rounded-2xl lg:flex lg:gap-5 lg:flex-col"
                    ...
                    <p className='  md:w-[360px] lg:text-lg lg:leading-relaxed  lg:px-2  lg:w-[380px] '>
                ...
                <div className=' absolute bg-white flex flex-col justify-center w-[390px] h-[600px]  gap-5 bottom-3 rounded-xl  md:top-0 md:right-10 lg:absolute  lg:bg-white lg:flex lg:flex-col lg:justify-center lg:w-[450px] lg:h-[640px] lg:px-8 lg:gap-5 lg:top-10 lg:right-[250px]'
                    data-aos="fade-left">
                    ...
                    <iframe
                        ...
                        width="325"
                        height="200"
                        src="https://www.youtube.com/embed/3ZbvZur2Tuc"
