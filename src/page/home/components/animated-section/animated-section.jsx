...
import { useTranslation } from "react-i18next";
 ...
 export  function AnimatedSection() {
  ...
  return (
    <div id="aboutService" className="w-[425px] h-[100vh] bg-gray-100  bg-gradient-to-t from-black via-rose-900 to-black relative  lg:w-full lg:h-[100vh] lg:bg-gray-100 lg:bg-gradient-to-t lg:from-black lg:via-rose-900 lg:to-black lg:relative">
