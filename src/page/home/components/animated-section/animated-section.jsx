...
import "./slider.css"; 
 ...
 export  function AnimatedSection() {
  ...
  return (
    <div className="w-full h-[100vh] bg-gray-100  bg-gradient-to-t from-black via-rose-900 to-black relative">
  <Slider className="slider_container w-full  " {...settings}>
    <div className="slide-item bg-customRed mt-[320px] relative  " >
      ...
      <div className="slide-content text-white absolute bottom-9 flex flex-col items-center text-center">
        <h1 className="text-4xl font-medium mb-2">Oqish himoyasi</h1>
    ...
    <div className="slide-item relative bg-customRed mt-[320px]">
      ...
      <div className="slide-content text-white absolute bottom-16  px-16 flex flex-col items-center text-center ">
        <h1 className="text-4xl font-medium mb-2">Video monitoring</h1>
        <p className="text-base  mt-2 ">
          Tashqi kameralar soni, ichki kameralar soni
        </p>
      </div>
    </div>
    <div className="slide-item bg-customRed mt-[320px] relative ">
    <img
      ...
      />
      <div className="slide-content text-white absolute bottom-9 flex flex-col items-center text-center">
        <h1 className="text-4xl font-medium mb-2">Multimedia </h1>
        <p className="text-base px-8 py-2">
        Televizorni boshqarish, Ko'p xonali zonalar (stereo), Uy kinoteatrlari (5.1, 7.1), WI-FI nuqtalari, Boshqaruv panellari        </p>
      </div>
    </div>
    <div className="slide-item bg-customRed mt-[320px] relative ">
      <img
      ...
      />
      <div className="slide-content text-white absolute bottom-9 flex flex-col items-center text-center">
        <h1 className="text-4xl font-medium mb-2">Xavfsizlik tizimi </h1>
        <p className="text-base px-16 py-2"> Termal yong'in detektorlari, Tutun detektorlari</p>
      </div>
    </div>
    <div className="slide-item bg-customRed mt-[320px] relative ">
      <img
      ...
      <div className="slide-content text-white absolute bottom-9 left-32 flex flex-col items-center text-center">
        <h1 className="text-4xl font-medium mb-2">Interkom </h1>
        <p className="text-base  py-2"> Tashqi panellar, ichki panellar</p>
      </div>
    </div>
    <div className="slide-item bg-customRed mt-[320px] relative ">
      <img
      ...
      />
      <div className="slide-content text-white absolute bottom-9  flex flex-col items-center text-center">
        <h1 className="text-4xl font-medium mb-2">Mikroiqlim </h1>
        <p className="text-base  py-2 mr-3"> Yerdan isitish zonalari, Radiatorlar guruhlari, Xona termostatlari (displeyli/displeysiz), Teskari aloqa bilan konditsioner tizimi, IQ aloqasi bo'lmagan konditsioner tizimi, Teskari aloqa bilan ventilyatsiya tizimi, Egzoz fanatlar</p>
      </div>
    </div>
  </Slider>
</div>
