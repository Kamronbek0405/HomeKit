...
export  const SellIcon2 = () => {
    return (
     <div className='lg:w-[80px] lg:h-[80px] lg:py-2  w-[35px] h-[35px] ml-4'>
       <svg
        className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium icon css-vubbuv"
        focusable="false"
        aria-hidden="true"
  ...
  export  const SellIcon3 = () => {
    return (
     <div className='lg:w-[75px] lg:h-[75px] lg:py-2 w-[35px] ml-2 h-[30px]'>
       <svg
        className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium icon css-vubbuv"
        focusable="false"
        aria-hidden="true"
